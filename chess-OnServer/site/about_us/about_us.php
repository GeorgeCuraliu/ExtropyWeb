...
<body>
    <div id="top-left">
        ...
        <img id="colored-squares" src="/chess-OnServer/site/!sources/img_svg/colores_squares.svg" alt="">
        <img id="ABOUT-US" src="/chess-OnServer/site/!sources/img_svg/ABOUT_US.svg" alt="">
        <img id="menu" src="/chess-OnServer/site/!sources/img_svg/menu_bar.svg" alt="">
    </div>
    ...
    <div id="container">
        ...
        <div id="departaments-container"><!--this is the departaments logo container-->
            ...
            <div class="departament deselected-departament" id="propaganda">
                <img class="departament-img" src="/chess-OnServer/site/!sources/img_svg/pr_logo.svg" alt="">
                <p class="departament-name">Public</p>
                <p style="top: 0" class="departament-name">relations</p>
            </div>
            <div class="departament" id="programming">
                <img class="departament-img" src="/chess-OnServer/site/!sources/img_svg/java-original.svg" alt="">
                <p class="departament-name">Programming</p>
            </div>
        </div>
